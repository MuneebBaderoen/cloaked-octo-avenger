...
var InputManager = function(options) {
    ...
    this.inputListener = options.inputListener || new Hammer(document.getElementsByTagName('body')[0]);
    ...
    //     this.engine.physics.render.camera.phi += ev.velocityY / 10;
    // }, this));

    // this.inputListener.on('panleft panright', _.bind(function(ev) {
    //     //console.log('panup fired', ev);
    //     this.engine.physics.render.camera.theta += ev.velocityX / 10;
    // }, this));
};
